...
public class ListTahap3Adapter extends RecyclerView.Adapter<ListTahap3Adapter.ViewHolder> {
    private Context context;
    private List<Tahap3Model> tahapList;
    private Listener listener;

    public ListTahap3Adapter(Context context, Listener listener) {
        this.context = context;
        this.listener = listener;
        tahapList = new ArrayList<>();
    }

    public void setData(List<Tahap3Model> pibList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.kpbc.setText("Harga Pajak : " + tahapList.get(i).getHargaPajak());
    }
    ...
    public interface Listener{
        void onClick(Tahap3Model dataPosition);
    }
}
