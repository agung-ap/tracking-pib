...
public class ListTahap4Adapter extends RecyclerView.Adapter<ListTahap4Adapter.ViewHolder> {
    private Context context;
    private List<Tahap4Model> tahapList;
    private Listener listener;

    public ListTahap4Adapter(Context context, Listener listener) {
        this.context = context;
        this.listener = listener;
        tahapList = new ArrayList<>();
    }

    public void setData(List<Tahap4Model> pibList) {
    ...
    public interface Listener{
        void onClick(Tahap4Model dataPosition);
    }
}
